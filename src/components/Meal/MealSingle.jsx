...
const MealSingle = ({ meal }) => {
  ...
  let youtube = meal?.youtube?.split("watch?v=").join("embed/");
  console.log(youtube)

  return (
    <div className="section-wrapper">
      <div className="container">
        <div className="breadcrumb bg-blueish text-white">
              ...
              <ul className="grid">
                {meal?.measures?.map((measure, idx) => (
                  <li key={idx} className="fs-14 flex align-end">
                    <span className="li-icon fs-12 text-blueish">
                      <FaUtensilSpoon />
                    </span>
                ...
                {instructions?.map((instruction, idx) => (
                  <li key={idx} className="fs-14">
                    <AiOutlineCheckSquare
                      size={18}
                      className="text-blueish li-icon"
                    />
